...
ROLE_MAP: dict[str, UserRole] = {
    ...
    "senior manager": UserRole.MANAGER,
    "sr manager": UserRole.MANAGER,
    "sr. manager": UserRole.MANAGER,
    "senior mgr": UserRole.MANAGER,
    "sr mgr": UserRole.MANAGER,
    "ceo": UserRole.VIEWER,
    "chief executive": UserRole.VIEWER,
    "chief executive officer": UserRole.VIEWER,
    "president": UserRole.VIEWER,
